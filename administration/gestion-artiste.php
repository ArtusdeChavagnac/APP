...
echo '<td><a href = "modifier-artiste.php?id=' . $row["idArtiste"] . '">Modifier</a></td>';
echo '<td><a href = "supprimer-artiste.php?id=' . $row["idArtiste"] . '">Supprimer</a></td>';
echo '</tr>';
}
} else {
...
<a href = "ajouter-artiste.php" class = "button">Ajouter</a>
</div>
<footer>
